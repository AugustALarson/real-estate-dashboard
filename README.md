...
3. Create charts, maps, and visualizations.
4. Integrate the visualizations into a user-friendly dashboard.
...
In this homework assignment, you will accomplish the following tasks:
...
1. Create a new repository **Including a Python gitignore** for this project called `real-estate-dashboard` or some other creative name. **Do not add this homework to an existing repository**.
...
####  Custom Visualizations - Optional Challenge

The above plots and dashboard organization are what your supervisor has asked you to create. If you would like you can replace any of the above visualizations with a custom visualization of equal or higher analytic value. You may also bring in any additional data of your choice. If you have a different city you would like to focus on you could do that as well. Any work on this optional challenge will be awarded extra credit. ,

---

### Dashboard

Now that you have worked out all of the code and analysis, you will use the Streamlit library to build an interactive dashboard for all of the visualizations. There are no hard requirements for the layout of this dashboard, so use your own imagination and creativity!
